...
`.github/scripts/blast_radius_stats.py`, 676 non-test symbols against 94 tests at
depth 1: 173 symbols reach at least one test, and those select a mean of 12.6 and
a median of 6, pruning a mean of 86.6% and a median of 93.6%. Mean pairwise
Jaccard overlap between two symbols' answers is 0.08. The 503 symbols that reach
